...
public class Spring {
	...
	public Vector getForce(Vector currentDisplacement) {
		double value = currentDisplacement.magnitude() - this.intialDisp.magnitude();
		return currentDisplacement.rescale(this.k*-1*value);
	}
